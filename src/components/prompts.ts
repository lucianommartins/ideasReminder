 ...
 */
export const FIXED_TEXT_PROMPT_FOR_AUDIO = "answer the question present in this audio. if there is no question, interpret what the user said and ask what the user wants to do with this information";
...
export const AUTH_MESSAGES = {
    ...
    INITIATE_AUTH_INSTRUCTIONS: `To connect your Google Tasks account, please open this link in your browser:
